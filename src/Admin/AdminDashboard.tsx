...
// Kini mao gihapon ang imong mga page components
...
// ===================================================================
// 0. ANG CSS ISIP USA KA COMPONENT (Walay gi-usab)
// ===================================================================
  ...
  <style>{`
    ...
    */
    ion-card {
      ...
      /* Kung gusto ka naay nipis nga border, i-uncomment (kuhaa ang /* ug */) ang linya sa ubos.
...
// ===================================================================
// 1. Admin_AdminHeaderBar COMPONENT (Walay gi-usab)
// ===================================================================
const Admin_AdminHeaderBar: React.FC = () => {
  // ... (ang sulod nga logic parehas ra, wala gi-usab)
...
// ===================================================================
// 2. Admin_AdminSidebar COMPONENT
// ===================================================================
...
const Admin_AdminSidebar: React.FC<StaffSidebarProps> = ({ 
  ...
  return (
    <IonMenu 
      ...
      // ✅✅✅ GI-ILISDAN NA SA "overlay" PARA DILI MO-ISBOG ANG CONTENT ✅✅✅
      type="overlay" 
      side="start" 
      style={{ "--border": "0px", "--box-shadow": "none" }}
    > 
      
      {/* --- Gikuha na ang IonHeader diri --- */}
...
const AdminDashboard: React.FC = () => {
  ...
  const renderContent = () => {
    // ... (ang sulod sa renderContent() parehas ra, wala gi-usab)
    switch (activeTab) {
      case "dashboard":
  ...
  return (
    // ✅✅✅ KINI ANG BAG-O NGA "OVERLAY" LAYOUT ✅✅✅
    // Gigamit nato ang React Fragment (<>) para i-return ang duha ka main components
    <> 
      {/* Ang CSS component */}
      <DashboardStyles />
