...
  
  // ✨ BAG-O: State para sa role checking
  const [userRole, setUserRole] = useState<string | null>(null); 

  // --- DATA FETCHING (MODIFIED TO INCLUDE ROLE CHECK) ---
  useEffect(() => {
    // KINAHANGLAN: I-check kung Verified O ADMIN role
...
    fetchData();
  }, [reportType, otpVerified, userRole]); // IDINAGDAG ANG userRole
...
  // 🛑 CORE LOGIC GI-USAB: Verify OTP ug I-Check ang 'admin' Role
