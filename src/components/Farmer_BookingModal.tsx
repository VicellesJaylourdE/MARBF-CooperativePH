...
import { IonModal, IonToast, IonAlert } from "@ionic/react";
...
const BookingModal: React.FC<BookingModalProps> = ({
    ...
    const handleSubmit = async () => {
        ...
        if (quantity > maxQuantity) {
            setAlertMsg(`Cannot book ${quantity} units. Only ${maxQuantity} available.`);
            setShowAlert(true);
            return;
        }
        ...
        if (paymentMethod === "gcash" && !gcashRefNo.trim()) {
            setAlertMsg("Enter GCash reference number.");
            setShowAlert(true);
            return;
        }
                ...
                <div className="booking-modal">
                    <div className="booking-card">
                        <div className="booking-header">
                            ...
                            <p>
                                Rate: ₱{price.toLocaleString()} / day | Available: {maxQuantity} units
                            </p>
                        </div>
                        ...
                        <form className="booking-form">
                            ...
                            {totalPrice > 0 && (
                                <div className="computation-box">
                                    ...
                                    <p>
                                        <strong>Units:</strong> {quantity} x ₱{price.toLocaleString()}
                                    </p>
                                    <hr />
                                    <h3>
                                        <strong>GRAND TOTAL:</strong> ₱{totalPrice.toLocaleString()}
                                    </h3>
                                </div>
                            )}
                            ...
                            {paymentMethod === "gcash" && (
                                <>
                                    ...
                                    <div className="form-group">
                                        ...
                                        />
                                        {proofFile && (
                                            <p style={{ fontSize: "0.8em", color: "green", margin: "5px 0 0 0" }}>
                                ...
                                <>
                                    <div className="info-card" style={{ backgroundColor: "#e6f7ff" }}>
                                        ...
                                        <p style={{ margin: 0, fontSize: "0.9em" }}>
                                            You selected Cash upon Delivery/Pickup. Payment of ₱
